...
const miamiArchives = [
  ...
  },
  {
    ...
    body: 'In the 1982 College World Series, Miami didn\'t just beat Wichita State; they pulled off one of the greatest trick plays in baseball history. Known as "The Grand Illusion," pitcher Mike Kasprzak faked a pickoff throw to first base. The entire Miami infield sold the fake perfectly, diving as if the ball had been overthrown into the dirt. While the Wichita State runner sprinted toward second base in a panic, Kasprzak casually stepped off the mound before revealing the ball and completing one of the most famous hidden-ball tricks in College World Series history. It was a play that required absolute nerve and flawless execution on the biggest stage.',
  },
  {
    id: 32,
    year: "Catcher U",
    ...
    <main className="min-h-screen bg-[#f47321] text-white flex flex-col justify-between selection:bg-white selection:text-[#f47321]">
      ...
      <div className="max-w-md sm:max-w-lg mx-auto px-4 pt-2 pb-6 w-full relative">
        ...
        <div className="relative bg-white text-stone-950 overflow-hidden border-2 border-stone-900 rounded-none">
          <div className="relative w-full h-[240px] sm:h-[270px] flex flex-col items-center justify-center overflow-hidden border-b-2 border-stone-900 pt-8">
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-4 space-y-3">
              ...
              <div className="transform -rotate-1 pb-2">
                <span className="block tracking-tight text-[55px] sm:text-[75px] leading-none text-[#f47321] vintage-number drop-shadow-[0_3px_6px_rgba(0,0,0,0.8)]">
